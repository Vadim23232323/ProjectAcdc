...
public class AnswerRepository implements Repository<Answer>{
    ...
    public AnswerRepository() {
        ...
        map.put(17L, new Answer(17L, 13L, "Ориентируешься по солнцу.", 8L));
        map.put(18L, new Answer(18L, 13L, "Ориентируешься по звездам.", 12L));

        // Quest car mystery
        map.put(19L, new Answer(19L, 15L, "Toyota Corolla.", 16L));
        map.put(20L, new Answer(20L, 15L, "Volkswagen Golf.", 20L));
        map.put(21L, new Answer(21L, 16L, "США.", 20L));
        map.put(22L, new Answer(22L, 16L, "Китай.", 17L));
        map.put(23L, new Answer(23L, 17L, "Ferrari.", 18L));
        map.put(24L, new Answer(24L, 17L, "Lamborghini.", 20L));
        map.put(25L, new Answer(25L, 18L, "Rolls-Royce.", 10L));
        map.put(26L, new Answer(26L, 18L, "Bugatti.", 19L));
    }
